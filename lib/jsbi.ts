...
class JSBI extends Array {
  ...
  static DataViewGetBigInt64(dataview: DataView, byteOffset: number, littleEndian: boolean = false) {
    return JSBI.asIntN(64, JSBI.DataViewGetBigUint64(dataview, byteOffset, littleEndian));
  }

  static DataViewGetBigUint64(dataview: DataView, byteOffset: number, littleEndian: boolean = false) {
  ...
  static DataViewSetBigInt64(dataview: DataView, byteOffset: number, value: JSBI, littleEndian: boolean = false) {
    JSBI.DataViewSetBigUint64(dataview, byteOffset, value, littleEndian);
  }

  static DataViewSetBigUint64(dataview: DataView, byteOffset: number, value: JSBI, littleEndian: boolean = false) {
